  ...
  if (current < value) {
    ...
    return (
      <div className="step in-progress">
        ...
        <NodeWrapper clickable={!!handleClick} onClick={clickEvent}>
          <div className="node">
            {valueAsIcon ? <StandardTypography color={colors.green4}>{value}</StandardTypography> : <Current />}
          </div>
        </NodeWrapper>
      </div>
    );
    ...
    return (
      <div className="step complete">
        ...
        <NodeWrapper clickable={!!handleClick} onClick={clickEvent}>
          <div className="node">
            {valueAsIcon ? (
              <StandardTypography color={colors.green4}>{value}</StandardTypography>
            ) : (
              <Icon color={colors.green4} weight="fas" iconClass="check" />
            )}
          </div>
        </NodeWrapper>
      </div>
