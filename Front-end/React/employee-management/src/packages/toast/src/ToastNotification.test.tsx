...
describe('Toast', () => {
  ...
  test('should display Toast with appropriate styles based on toast type passed as props', () => {
    ...
    expect(getByText(mockToastList[1].content as string).getAttribute('color')).toBe(colors.yellow5);
  });
  ...
  test('should display toast with custom properties passed as props', () => {
    ...
    expect(getByText(mockToastList[2].content as string).getAttribute('color')).toBe(colors.charcoal);
  });
});
