...
import '@emotion/core';
import Select, { components, Props, Styles, SelectComponentsConfig, IndicatorProps, Theme } from 'react-select';
...
const ClearIndicator = (props: IndicatorProps<Value, false>) => {
  return (
    <components.ClearIndicator {...props}>
      <Icon iconClass="times" weight="fas" color={colors.tertiary2} iconSize="1x" />
